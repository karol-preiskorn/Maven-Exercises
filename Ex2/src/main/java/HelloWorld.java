...
public class HelloWorld {
    ...
    public static void jwtEx0() throws JoseException {
        System.out.println("The following snippet uses JWE to both encrypt and decrypt the message \"Hello World!\" in just a few lines of code.");
    ...
    public static void jwtEx1() throws JoseException, MalformedClaimException {
        ...
        claims.setClaim("email","karol.preiskorn@gmail.com"); // additional claims/attributes about the subject can be added
